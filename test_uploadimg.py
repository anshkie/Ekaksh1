...
class TestUploadimg():
  ...
  def test_uploadimg(self):
    ...
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(1)").send_keys("C:\\fakepath\\image 1.png")
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(2)").click()
    self.driver.find_element(By.CSS_SELECTOR, "input:nth-child(2)").send_keys("demo1")
    self.driver.find_element(By.CSS_SELECTOR, "button:nth-child(3)").click()
    assert self.driver.switch_to.alert.text == "Image Uploaded Successfully"
